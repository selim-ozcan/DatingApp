...
namespace API.Controllers
{
    ...
    public class MessagesController: BaseApiController
    {
        ...
        public async Task<ActionResult<PagedList<MessageDto>>> GetMessages([FromQuery] MessageParams messageParams)
        {
            ...
            HttpContext.Response.AddPaginationHeader(new PaginationHeader(messages.CurrentPage, messages.PageSize, messages.TotalCount, messages.TotalPages));
        ...
        {
            var messageThread = await _uow.MessageRepository.GetMessageThread(User.GetUsername(), username);
